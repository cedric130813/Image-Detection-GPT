    ...
    if request.method == "POST":
        ...
        if img_path:
            ...
            response = openai.Completion.create(
                ...
                prompt=f"I want you to act as an retail recommendation system. You will suggest five similar retail items including its brand that a customer could buy in Singapore based on the suggestion request. My suggestion request is {im_class}",
                temperature=0.7,
                max_tokens=400)
